...
for i = 1:length(IT)
    ...
    Hcsui3          = pi*equations.Planck(wlt(i),Tcu+273.15,epsc(i));
    Hcshi           = pi*equations.Planck(wlt(i),Tch+273.15,epsc(i));
    Hssui           = pi*equations.Planck(wlt(i),Tsu+273.15,epss(i));
    Hsshi           = pi*equations.Planck(wlt(i),Tsh+273.15,epss(i));
