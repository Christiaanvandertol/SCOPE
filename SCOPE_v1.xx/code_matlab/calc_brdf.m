function directional = calc_brdf(options,directional,spectral,angles,rad,atmo,soil,leafopt,canopy,meteo,profiles,thermal,leafbio)
...
for j=1:(noa+noah_o+noap_o)
    ...
    if options.calc_fluor
        directional_rad = RTMf(spectral,directional_rad,soil,leafopt,canopy,directional_gap,directional_angles,profiles,leafbio,0);
