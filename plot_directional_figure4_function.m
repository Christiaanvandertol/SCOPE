function plot_directional_figure4_function
...
[d,txt] = xlsread('../directional_file.xlsx');

Anglesfile      = txt(1,2);
ValuesTfile         = txt(2,2);
ValuesBRDFfile      = txt(3,2);
ValuesFluorfile     = txt(4,2);

Angles = load(Anglesfile{:});
ValuesT = load(ValuesTfile{:});
ValuesBRDF = load(ValuesBRDFfile{:});
ValuesFluor = load(ValuesFluorfile{:});

% Angles                      = load('../output/fluorescence_dir_2013-04-26-1003/Directional/Angles (SunAngle 30.00 degrees).dat');
% ValuesT                     = load('../output/fluorescence_dir_2013-04-26-1003/Directional/Temperatures (SunAngle 30.00 degrees).dat');
% ValuesBRDF                  = load('../output/fluorescence_dir_2013-04-26-1003/Directional/BRDF (SunAngle 30.00 degrees).dat');
% ValuesFluor                 = load('../output/fluorescence_dir_2013-04-26-1003/Directional/Fluorescence (SunAngle 30.00 degrees).dat');

%Angles                      = load('../output/test_2013-04-12-1320/Directional/Angles (SunAngle 30.00 degrees).dat');
%ValuesT                     = load('../output/test_2013-04-12-1320/Directional/Temperatures (SunAngle 30.00 degrees).dat');
%ValuesBRDF                  = load('../output/test_2013-04-12-1320/Directional/BRDF (SunAngle 30.00 degrees).dat');
%ValuesFluor                 = load('../output/test_2013-04-12-1320/Directional/Fluorescence (SunAngle 30.00 degrees).dat');
